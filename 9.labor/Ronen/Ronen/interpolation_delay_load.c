 ...
 */
FARPROC WINAPI interpolationDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = interpolationDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = interpolationDelayLoadWin32FailureHook;
#endif
